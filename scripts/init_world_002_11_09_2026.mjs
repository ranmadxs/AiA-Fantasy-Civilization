...
const seed = "init_world_002_11_09_2026";
const monthsToRun = 240;
const snapshotMonths = [0, 120, 240];
const nationCount = 6;
const outputDir = `target/images/${seed}`;
const reportPath = `target/images/${seed}/report.html`;
